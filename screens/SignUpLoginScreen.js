    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        <ScrollView style={{width:'100%'}}>
          ...
          <Text
            style={{justifyContent:'center', alignSelf:'center', fontSize:30,color:'#013a85',margin:50}}
            >REGISTRATION</Text>
          <TextInput
          ...
          <View style={styles.modalBackButton}>
            ...
            >
            <Text style={{color:'#013a85'}}>CANCEL</Text>
            </TouchableOpacity>
          </View>
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'#013a85', fontSize:18,marginLeft:10}}>Enter Username:</Text>
          ...
          <Text style={{color:'#013a85', fontSize:18,marginLeft:10}}>Enter Password:</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
